  ...
  return (
    <footer className="bg-gray-900 dark:bg-black text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Values */}
        <div className="border-t border-gray-800 dark:border-gray-800 mt-10 pt-8">
          <div className="flex flex-wrap justify-center gap-4 text-xs text-gray-500">
            {['Qualidade', 'Compromisso', 'Criatividade', 'Profissionalismo', 'Confiança', 'Satisfação'].map(v => (
              <span key={v} className="px-3 py-1 rounded-full bg-gray-800 dark:bg-gray-800/60 border border-gray-700 dark:border-gray-800">{v}</span>
            ))}
          </div>
        </div>
