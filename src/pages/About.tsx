...
export default function About() {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      {/* Google AdSense Banner (AdSense loves ads on informational content) */}
      ...
      <section className="max-w-5xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-3xl p-8 shadow-sm hover:shadow-md transition-all">
          ...
          <div className="bg-white border border-gray-100 rounded-3xl p-8 shadow-sm hover:shadow-md transition-all">
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              Ser a marca líder e mais admirada em Angola pela qualidade gastronómica, criatividade visual e excelência no atendimento ao cliente até 2028.
            </p>
          </div>
